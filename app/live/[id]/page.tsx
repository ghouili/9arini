...
const copy = {
  fr: {
    ...
    lockedBody: "Réserve ta place sur la page du cours (la 1ère séance est gratuite) et le lien s'ouvrira ici.",
  ...
  ar: {
    ...
    lockedBody: "احجز مكانك من صفحة الحصة (الحصة الأولى مجانية) والرابط يتفتحلك هوني.",
          ...
          >
            ...
            <div style={{ textAlign: "center", margin: "clamp(20px,4vw,32px) 0 8px" }}>
              ...
              {showCountdown ? (
                ...
                <div style={{ display: "inline-flex", alignItems: "center", gap: 7, color: "#CDD9E8", fontSize: 13.5, fontWeight: 600, margin: "18px 0 6px" }}>
