  ...
  ar: {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          // LEGAL-REVIEW: the lawful bases in parentheses are product-team proposals (see the bracket above).
          "الإيميل ← نعملو حسابك ونتثبّتو منّك برمز وحيد (تنفيذ الخدمة اللي طلبتها). رقم التليفون، إذا عطيتو ← للرسائل اللي تنجّم تبعثهملك Tnajem على حسابك وحصصك (تأكيد حجز مثلاً)، وخلاص؛ وعمرو ما يتوّرى لأستاذ ولا لتلميذ.",
