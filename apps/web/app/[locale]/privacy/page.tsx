    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "E-mail du parent → créer son compte parent et le relier à son enfant. Avec ce compte, le parent voit les séances réservées et peut LIRE les conversations de son enfant — l'enfant en est informé sur chaque conversation. Le parent ne peut rien écrire, ni annuler, à sa place. Les coordonnées des profs ne lui sont jamais communiquées non plus.",
          "Suppression de ton compte → tu peux la demander depuis « Mon profil ». Nous te laissons 30 jours pour changer d'avis, puis ton compte, tes réservations, tes messages et tes informations sont supprimés définitivement. Deux choses survivent, sans lien avec toi : les avis que tu as écrits, qui deviennent anonymes (la note d'un prof ne doit pas changer parce qu'un élève est parti), et le registre des annulations, qui ne contient que des montants et une séance.",
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "إيميل الولي ← باش يتعمل حسابو ويترابط بولدو. بالحساب هذا الولي يشوف الحصص المحجوزة ويقرا محادثات ولدو — والولد يتعلم بيها في كل محادثة. الولي ما ينجّمش يكتب ولا يلغي في بلاصتو. ومعلومات الاتصال متاع الأساتذة عمرها ما تتعطالو.",
          "مسح حسابك ← تنجّم تطلبو من « حسابي ». نخلّيولك 30 يوم باش تبدّل رايك، ومن بعد حسابك، حجوزاتك، رسائلك ومعلوماتك يتمسحو نهائيًا. زوز حاجات يبقاو، وما عندهمش علاقة بيك: التقييمات اللي كتبتهم، اللي يولّيو مجهولين (نقطة الأستاذ ما لازمش تتبدّل خاطر تلميذ مشى)، وسجل الإلغاءات، اللي ما فيه كان مبالغ وحصة.",
