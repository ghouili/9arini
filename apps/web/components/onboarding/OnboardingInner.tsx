...
const copy = bilingual({
  fr: {
    ...
    fine: `Gratuit pendant le pilote : Tnajem ne prend rien. Plus tard, ${COMMISSION_PCT} % sur chaque élève payant via Tnajem, plus un abonnement — gratuit avec un seul cours en ligne à la fois, à partir de ${SUB_FROM} TND/mois au-delà.`,
    perks: [
  ...
  ar: {
    yourName: "اسمك…",
    // phase-a lane L3 (A22)
    fine: `فابور في فترة التجربة : Tnajem ما تاخذ والو. من بعد، ${COMMISSION_PCT} % على كل تلميذ يخلّص من Tnajem، زائد اشتراك فابور بدرس واحد ومن ${SUB_FROM} دينار في الشهر لفوق.`,
    perks: [
