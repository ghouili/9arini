...
const fr = {
  ...
  checkout: {
    ...
    flouci: "Portefeuille · sans carte",
    card: "Carte / e-DINAR",
    cardSub: "Konnect · La Poste",
    d17: "La Poste mobile",
    trust: "Paiement 100% sécurisé. Annulation gratuite jusqu'à 24h avant. Tu ne paies la suite que si la 1ère séance t'a plu.",
    ...
    pending: "Le paiement réel s'active après l'accord juridique (voir README).",
  ...
  live: {
    ...
    cam: "Caméra", mic: "Micro", note: "Ta caméra est optionnelle — tu peux suivre en silence et écrire dans le chat.", join: "Entrer dans la classe",
    lowData: "Mode données réduites (480p) activé.",
  },
  auth: {
...
const ar: typeof fr = {
  ...
  checkout: {
    ...
    method: "طريقة الدفع",
    flouci: "محفظة · بدون بطاقة",
    card: "بطاقة / e-DINAR",
    cardSub: "Konnect · البريد",
    d17: "البريد عبر الهاتف",
    trust: "دفع آمن 100%. إلغاء مجاني حتى 24 ساعة قبل. ما تخلّصش الباقي كان عجبتك الحصة الأولى.",
    ...
    okCta: "شوف حصصي",
    pending: "الدفع الحقيقي يتفعّل بعد الموافقة القانونية (شوف README).",
  ...
  live: {
    ...
    cam: "الكاميرا", mic: "الميكرو", note: "الكاميرا اختيارية — تنجم تتابع بصمت وتكتب في الدردشة.", join: "ادخل للحصة",
    lowData: "وضع البيانات المخفّضة (480p) مفعّل.",
  },
  auth: {
